...
export default function SocialMedia({ colorName='black', size=8 }) {
    ...
    return (
        <div className={`w-min flex gap-x-6 py-2 px-1 items-center justify-center ${bgColor} social`}>
          <a href="https://www.instagram.com/vohincubator/">
