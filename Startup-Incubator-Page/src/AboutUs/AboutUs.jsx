  ...
  return (
    <>
      <div className="w-full h-auto bg-white py-4 px-4 ">
        <h1 className="text-orange-600 text-center text-6xl">About Us</h1>
        <div className="page w-full bg-blue-100 my-3">
          ...
          <div className="combined_total flex justify-center items-center my-3 py-4 flex-col md:flex-col lg:flex-row xl:flex-row">
            ...
            <div className="flex-1 content1 px-4 ml-6 flex justify-center items-center flex-col">
              <h3 className="text-center text-3xl underline">{head1}</h3>
              <p className="text-2xl mt-4 self-start leading-8">
                {para1}
              </p>
            </div>
            <div className="flex-1 content1 px-4 ml-6 flex justify-center items-center flex-col">
              <h3 className="text-center text-3xl underline">{head2}</h3>
              <p className="text-2xl mt-4 self-start leading-8">
                {para2}
              </p>
            </div>
